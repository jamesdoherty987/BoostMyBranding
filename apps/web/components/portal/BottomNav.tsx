...
const TABS: TabDef[] = [
  { href: '/portal/dashboard', label: 'Home', icon: Home, tiers: 'all' },
  {
    href: '/portal/upload',
    label: 'Upload',
    icon: Upload,
  ...
  { href: '/portal/chat', label: 'Chat', icon: MessageSquare, tiers: 'all' },
  { href: '/portal/settings', label: 'You', icon: User, tiers: 'all' },
];
