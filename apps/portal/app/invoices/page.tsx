...
export default function InvoicesPage() {
  ...
  const { client } = data;
  const demo = [
    { id: 'inv_003', month: 'May 2026', amount: 80000, status: 'pending' as const, due: '2026-05-15' },
    { id: 'inv_002', month: 'April 2026', amount: 80000, status: 'paid' as const, paid: '2026-04-02' },
    { id: 'inv_001', month: 'March 2026', amount: 80000, status: 'paid' as const, paid: '2026-03-02' },
  ];
