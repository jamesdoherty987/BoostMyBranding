...
export const TIERS: TierConfig[] = [
  {
    ...
    priceCents: 20000,
    setupCents: 0,
    description: '10 hand-crafted posts a month on Instagram and TikTok, run by our team.',
    features: [
      '10 posts / month',
  ...
  },
  {
    ...
    priceCents: 25000,
    setupCents: 80000,
    description: 'Socials plus a fast, modern website we keep current as your business changes.',
    features: [
      'Everything in Just Socials',
      'Custom website and hosting',
      'Unlimited change requests',
      'Booking forms and map',
      'Priority support',
    ],
    cta: 'Go full package',
    highlight: true,
  },
  {
    ...
    priceCents: 2000,
    setupCents: 100000,
    description: 'A modern website, built custom and kept fresh every month.',
    features: [
