...
export const TIERS: TierConfig[] = [
  {
    ...
    priceCents: 20000,
    setupCents: 0,
    description: 'Instagram and TikTok run by a small, dedicated team. 10 posts a month, every one written in your voice.',
    features: [
      '10 posts / month',
      'Instagram and TikTok',
      'Reels, Stories, and grid posts',
  ...
  },
  {
    ...
    priceCents: 25000,
    setupCents: 80000,
    description: 'Socials plus a fast, modern website we keep current as your menu, services, and hours change.',
    features: [
      'Everything in Just Socials',
      'Custom website and hosting',
      'Unlimited change requests',
      'Booking form, map, hours',
      'Priority support, reply within the hour',
    ],
    cta: 'Go full package',
    highlight: true,
  },
  {
    ...
    priceCents: 2000,
    setupCents: 100000,
    description: 'A modern, fast website — kept fresh with ongoing content updates so it never goes stale.',
    features: [
