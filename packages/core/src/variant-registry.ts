...
export const REVIEWS_VARIANT_OPTIONS: VariantOption[] = [
  ...
  },
  {
    ...
    description: 'Stacked cards visitors can drag through. Playful and tactile.',
    preview: svg(`<rect width="300" height="200" fill="#fef3c7"/><rect x="60" y="50" width="140" height="100" rx="12" fill="#fff" transform="rotate(-4 130 100)" stroke="#e2e8f0"/><rect x="70" y="50" width="140" height="100" rx="12" fill="#fff" stroke="#e2e8f0"/><rect x="80" y="50" width="140" height="100" rx="12" fill="#fff" transform="rotate(4 150 100)" stroke="#e2e8f0"/>`),
    requires: [{ field: 'reviews', minItems: 3, hint: '3+ reviews' }],
